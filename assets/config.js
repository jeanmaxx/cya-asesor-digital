...
window.ADVISOR_FALLBACK_SERVICES = [
  {
    ...
    requirements: ["Al menos 46 días naturales en situación de desempleo.","Cuenta AFORE con al menos 3 años de antigüedad y 2 años cotizados al IMSS.","No haber ejercido este retiro en los últimos 5 años.","Expediente de Identificación del Trabajador actualizado."],
    notice: "Este retiro puede disminuir semanas cotizadas; conviene revisar el impacto antes de solicitarlo.", cta: "Quiero revisar mi caso", sort_order: 10, is_visible: true
  },
  {
    service_key: "pension-imss", title: "Asesoría en Pensión IMSS · Ley 73 / Ley 97",
    summary: "Analizamos tu régimen, semanas cotizadas, edad y documentación para identificar la ruta previsional aplicable.",
    requirements: ["CURP, NSS e identificación oficial.","Constancia de semanas cotizadas y, de ser posible, estado de cuenta AFORE.","Ley 73: cotizaciones previas al 1 de julio de 1997 y mínimo 500 semanas, sujeto a vigencia y conservación de derechos.","Ley 97: en 2026 el requisito progresivo es de 875 semanas; 60–64 años para cesantía y 65 para vejez."],
    notice: "Cada expediente debe revisarse de manera individual; semanas, vigencia y modalidad pueden cambiar el resultado.", cta: "Quiero revisar mi pensión", sort_order: 20, is_visible: true
  },
  {
    service_key: "ppr", title: "Plan Personal de Retiro",
    summary: "Diseñamos una ruta de ahorro de largo plazo orientada a complementar tu retiro según tus objetivos y horizonte.",
    requirements: ["Edad, horizonte de retiro y capacidad de aportación.","Objetivo de ahorro y nivel de liquidez que necesitas.","RFC e identificación para evaluar alternativas disponibles.","Las aportaciones a ciertos PPR pueden tener tratamiento fiscal favorable si cumplen los requisitos aplicables."],
    notice: "Las condiciones, costos y beneficios dependen de la institución y del producto contratado.", cta: "Quiero conocer opciones", sort_order: 30, is_visible: true
  },
  {
    service_key: "inconsistencias-imss", title: "Resolución de inconsistencias ante el IMSS",
    ...
    requirements: ["CURP, NSS y correo electrónico personal.","Acta de nacimiento e identificación oficial digitalizadas.","Documento del IMSS que muestre el NSS cuando corresponda.","La documentación exacta depende del tipo de inconsistencia que se necesite regularizar."],
    notice: "La resolución y documentación final dependen del trámite y de la autoridad competente.", cta: "Quiero revisar mi inconsistencia", sort_order: 40, is_visible: true
  }
];
...
(() => {
  ...
  if(admin){
    addCss('visual-identity-admin-v4.css?v=20260913-vi4c','vi4-admin-css');
    addCss('editor-floating-actions.css?v=20260913-rail3','editor-action-rail-css');
    addModule('visual-identity-admin-v4.js?v=20260913-vi4c','vi4-admin-js');
