...
(() => {
  ...
  if(admin){
    ...
    addCss('advisor-booking-admin-v2.css?v=20260916-booking4','ttd-booking-admin-css');
    ...
    addModule('advisor-booking-admin-v2.js?v=20260916-booking4','ttd-booking-admin-js');
    addModule('advisor-booking-layout-fix.js?v=20260916-booking4','ttd-booking-layout-fix-js');
  }else if(!otros){
